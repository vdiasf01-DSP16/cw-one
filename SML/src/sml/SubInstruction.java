...
/**
 * This class executes the instruction of subtracting the values 
 * between two registers storing result into first supplied register.
 * 
 * e.g.: 'Label' 'sub' 'R1' 'R2' 'R3'
 *       R1 = R2 - R3
 * 
 * @author someone
 */
public class SubInstruction extends Instruction {
    ...
    public void execute(Machine m) {
        ...
        // The subtraction core operation.
